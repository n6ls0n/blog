...
class ActionDispatch::Routing::Mapper
  # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#2377
  ...
  class << self
    # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner; end

    # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#27
    def backtrace_cleaner=(val); end

    # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#412
    def normalize_name(name); end

    # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#397
    def normalize_path(path); end

    # source://actionpack/8.0.0/lib/action_dispatch/routing/mapper.rb#26
...
class ActionDispatch::Routing::RouteSet
  ...
  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#388
  def initialize(config = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#676
  def add_polymorphic_mapping(klass, options, &block); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#645
  def add_route(mapping, name); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#680
  def add_url_helper(name, options, &block); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#419
  def api_only?; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#466
  def append(&block); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#905
  def call(env); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#490
  def clear!; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#440
  def default_env; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#423
  def default_scope; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#427
  def default_scope=(new_default_scope); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#356
  def default_url_options; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#356
  def default_url_options=(_arg0); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#511
  def define_mounted_helper(name, script_namer = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#355
  def disable_clear_and_finalize; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#355
  def disable_clear_and_finalize=(_arg0); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#459
  def draw(&block); end
  ...
  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#408
  def eager_load!; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#641
  def empty?; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#357
  def env_key; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#820
  def extra_keys(options, recall = T.unsafe(nil)); end

  # source://devise//lib/devise/rails/routes.rb#8
  def finalize!; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#848
  def find_script_name(options); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#354
  def formatter; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#354
  def formatter=(_arg0); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#29
  def from_requirements(requirements); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#824
  def generate_extras(options, recall = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#538
  def generate_url_helpers(supports_path); end

  def inspect; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#507
  ...
  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#844
  def optimize_routes_generation?; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#852
  def path_for(options, route_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#357
  def polymorphic_mappings; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#470
  def prepend(&block); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#911
  def recognize_path(path, environment = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#926
  def recognize_path_with_request(req, path, extras, raise_on_missing: T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#415
  def relative_url_root; end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#431
  ...
  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#857
  def url_for(options, route_name = T.unsafe(nil), url_strategy = T.unsafe(nil), method_name = T.unsafe(nil), reserved = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#530
  def url_helpers(supports_path = T.unsafe(nil)); end

  private

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#474
  def eval_block(block); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#835
  def generate(route_name, options, recall = T.unsafe(nil), method_name = T.unsafe(nil)); end

  # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#435
  def make_request(env); end

  class << self
    # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#361
    def default_resources_path_names; end

    # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#365
...
class Devise::Controllers::Responder < ::ActionController::Responder
  class << self
    ...
    def error_status=(new_value); end

    # source://activesupport/8.0.0/lib/active_support/class_attribute.rb#12
    def redirect_status; end

    # source://activesupport/8.0.0/lib/active_support/class_attribute.rb#15
    def redirect_status=(new_value); end
  end
end
...
class Devise::FailureApp < ::ActionController::Metal
  ...
  # source://actionpack/8.0.0/lib/action_dispatch/routing/url_for.rb#100
  def default_url_options; end
  ...
  # source://actionpack/8.0.0/lib/abstract_controller/callbacks.rb#36
  def raise_on_missing_callback_actions; end

  # source://actionpack/8.0.0/lib/abstract_controller/callbacks.rb#36
  def raise_on_missing_callback_actions=(val); end

  # source://actionpack/8.0.0/lib/action_controller/metal/redirecting.rb#17
  ...
  class << self
    ...
    # source://actionpack/8.0.0/lib/action_dispatch/routing/route_set.rb#612
    def _routes; end
