...
class Rails::Application < ::Rails::Engine
  # source://railties/8.0.0/lib/rails/application.rb#109
  ...
  # source://railties/8.0.0/lib/rails/application.rb#102
  def autoloaders; end

  # source://railties/8.0.0/lib/rails/engine.rb#516
  def build_middleware_stack; end

  # source://railties/8.0.0/lib/rails/application.rb#451
  def config; end

  # source://railties/8.0.0/lib/rails/application.rb#455
  def config=(_arg0); end

  # source://railties/8.0.0/lib/rails/application.rb#288
  def config_for(name, env: T.unsafe(nil)); end

  # source://railties/8.0.0/lib/rails/application.rb#371
  def console(&blk); end

  # source://railties/8.0.0/lib/rails/application.rb#492
  def credentials; end

  # source://railties/8.0.0/lib/rails/application.rb#456
  def credentials=(_arg0); end

  # source://railties/8.0.0/lib/rails/application.rb#104
  def default_url_options(*_arg0, **_arg1, &_arg2); end

  # source://railties/8.0.0/lib/rails/application.rb#104
  def default_url_options=(arg); end

  # source://railties/8.0.0/lib/rails/application.rb#244
  def deprecators; end

  # source://railties/8.0.0/lib/rails/application.rb#550
  def eager_load!; end

  # source://railties/8.0.0/lib/rails/application.rb#511
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # source://railties/8.0.0/lib/rails/application.rb#317
  def env_config; end

  # source://railties/8.0.0/lib/rails/application.rb#102
  def executor; end

  # source://railties/8.0.0/lib/rails/application.rb#377
  def generators(&blk); end

  # source://railties/8.0.0/lib/rails/application.rb#524
  ...
  # source://railties/8.0.0/lib/rails/application.rb#438
  def initialize!(group = T.unsafe(nil)); end

  # source://railties/8.0.0/lib/rails/application.rb#134
  def initialized?; end

  # source://railties/8.0.0/lib/rails/application.rb#359
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties/8.0.0/lib/rails/application.rb#445
  def initializers; end

  # source://railties/8.0.0/lib/rails/application.rb#388
  def isolate_namespace(mod); end

  # source://railties/8.0.0/lib/rails/application.rb#172
  def key_generator(secret_key_base = T.unsafe(nil)); end

  # source://railties/8.0.0/lib/rails/application.rb#544
  def load_generators(app = T.unsafe(nil)); end

  # source://railties/8.0.0/lib/rails/application.rb#236
  def message_verifier(verifier_name); end

  # source://railties/8.0.0/lib/rails/application.rb#208
  def message_verifiers; end

  # source://railties/8.0.0/lib/rails/application.rb#540
  def migration_railties; end

  # source://railties/8.0.0/lib/rails/application.rb#141
  def name; end
  ...
  # source://railties/8.0.0/lib/rails/application.rb#352
  def rake_tasks(&block); end

  # source://railties/8.0.0/lib/rails/application.rb#160
  def reload_routes!; end

  # source://railties/8.0.0/lib/rails/application.rb#164
  ...
  # source://railties/8.0.0/lib/rails/application.rb#414
  def require_environment!; end

  # source://railties/8.0.0/lib/rails/application.rb#419
  def routes_reloader; end

  # source://railties/8.0.0/lib/rails/application.rb#145
  def run_load_hooks!; end

  # source://railties/8.0.0/lib/rails/application.rb#365
  def runner(&blk); end

  # source://railties/8.0.0/lib/rails/application.rb#100
  def sandbox; end
  ...
  # source://railties/8.0.0/lib/rails/application.rb#474
  def secret_key_base; end

  # source://railties/8.0.0/lib/rails/application.rb#383
  def server(&blk); end

  # source://railties/8.0.0/lib/rails/application.rb#520
  def to_app; end

  # source://railties/8.0.0/lib/rails/application.rb#426
  def watchable_args; end

  protected

  # source://railties/8.0.0/lib/rails/application.rb#623
  def default_middleware_stack; end

  # source://railties/8.0.0/lib/rails/application.rb#628
  def ensure_generator_templates_added; end

  # source://railties/8.0.0/lib/rails/application.rb#589
  def ordered_railties; end

  # source://railties/8.0.0/lib/rails/application.rb#611
  def railties_initializers(current); end

  # source://railties/8.0.0/lib/rails/application.rb#578
  def run_console_blocks(app); end

  # source://railties/8.0.0/lib/rails/application.rb#568
  def run_generators_blocks(app); end

  # source://railties/8.0.0/lib/rails/application.rb#573
  def run_runner_blocks(app); end

  # source://railties/8.0.0/lib/rails/application.rb#583
  def run_server_blocks(app); end

  # source://railties/8.0.0/lib/rails/application.rb#557
  def run_tasks_blocks(app); end

  private

  # source://railties/8.0.0/lib/rails/application.rb#641
  def build_middleware; end

  # source://railties/8.0.0/lib/rails/application.rb#634
  def build_request(env); end

  # source://railties/8.0.0/lib/rails/application.rb#645
  def coerce_same_site_protection(protection); end

  # source://railties/8.0.0/lib/rails/application.rb#649
  def filter_parameters; end

  class << self
    # source://railties/8.0.0/lib/rails/application.rb#407
    def add_lib_to_load_path!(root); end

    # source://railties/8.0.0/lib/rails/application.rb#84
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties/8.0.0/lib/rails/application.rb#88
    def find_root(from); end

    # source://railties/8.0.0/lib/rails/application.rb#71
    def inherited(base); end

    # source://railties/8.0.0/lib/rails/application.rb#80
    def instance; end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  # source://railties/8.0.0/lib/rails/application/configuration.rb#30
  def initialize(*_arg0); end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#14
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#561
  def annotations; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#28
  def api_only; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#376
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#471
  def autoload_lib(ignore:); end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#483
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#388
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#495
  def colorize_logging; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#499
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#566
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#434
  def database_configuration; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#390
  def debug_exception_response_format; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#394
  def debug_exception_response_format=(_arg0); end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#583
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#360
  def enable_reloading; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#364
  def enable_reloading=(value); end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#28
  def encoding; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#368
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#595
  def inspect; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#416
  def load_database_yaml; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#92
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#383
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#396
  def paths; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#575
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#356
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#504
  def secret_key_base; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#514
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#541
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#557
  ...
  # source://railties/8.0.0/lib/rails/application/configuration.rb#622
  def credentials_defaults; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#632
  def generate_local_secret; end

  # source://railties/8.0.0/lib/rails/application/configuration.rb#644
  def generate_local_secret?; end
end
