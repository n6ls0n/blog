...
class Pagy
  ...
  # @raise [VariableError]
  #
  # source://pagy//lib/pagy.rb#133
  def setup_params_var; end

  # @raise [VariableError]
  #
  # source://pagy//lib/pagy.rb#138
...
module Pagy::Frontend
  ...
  #
  # source://pagy//lib/pagy/frontend.rb#42
  def pagy_info(pagy, pagy_id: T.unsafe(nil), item_name: T.unsafe(nil), item_i18n_key: T.unsafe(nil)); end

  # Return a performance optimized lambda to generate the HTML links
  # Benchmarked on a 20 link nav: it is ~22x faster and uses ~18x less memory than rails' link_to
  #
  # source://pagy//lib/pagy/frontend.rb#58
  def pagy_link_proc(pagy, link_extra: T.unsafe(nil)); end

  # Generic pagination: it returns the html with the series of links to the pages
  #
  # source://pagy//lib/pagy/frontend.rb#18
  def pagy_nav(pagy, pagy_id: T.unsafe(nil), link_extra: T.unsafe(nil), nav_aria_label: T.unsafe(nil), nav_i18n_key: T.unsafe(nil), **vars); end

  # Similar to I18n.t: just ~18x faster using ~10x less memory
  # (@pagy_locale explicitly initialized in order to avoid warning)
  #
  # source://pagy//lib/pagy/frontend.rb#77
  def pagy_t(key, opts = T.unsafe(nil)); end

  private

  # source://pagy//lib/pagy/frontend.rb#83
  def nav_aria_label_attr(pagy, nav_aria_label, nav_i18n_key, count: T.unsafe(nil)); end

  # source://pagy//lib/pagy/frontend.rb#92
  def next_aria_label_attr; end

  # source://pagy//lib/pagy/frontend.rb#105
  def next_html(pagy, link, text: T.unsafe(nil)); end

  # source://pagy//lib/pagy/frontend.rb#88
  def prev_aria_label_attr; end

  # source://pagy//lib/pagy/frontend.rb#96
  def prev_html(pagy, link, text: T.unsafe(nil)); end
end
...
module Pagy::UrlHelpers
  ...
  # Overridable by the jsonapi extra
  #
  # source://pagy//lib/pagy/url_helpers.rb#22
  def pagy_set_query_params(page, vars, params); end
